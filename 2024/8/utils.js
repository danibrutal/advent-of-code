...
const findAntinodes = (map, antenaPair, antinodesSet) => {
  ...
  const distanceX = Math.abs(antena1[0] - antena2[0]);
  const distanceY = Math.abs(antena1[1] - antena2[1]);
  ...
  if (antena1[0] === antena2[0]) {
    ...
    //
    let possibleXLoc1 =
      antena1[0] > antena2[0] ? antena1[0] + distanceX : antena1[0] - distanceX;

    let possibleXLoc2 =
      antena1[0] > antena2[0] ? antena2[0] - distanceX : antena2[0] + distanceX;
